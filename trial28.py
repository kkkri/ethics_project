...
def generate_dynamic_attendance(n, k, days=10, collusion_rate=0.3, dynamic_change_prob=0.1):
...
plt.title("True Detection Rate (TDR) with Dynamic Behavior (n=100)")
plt.show()
...
plt.xlabel("Number of Audits (m)")
plt.ylabel("Peer Confirmations (k)")
plt.title("False Positive Rate (FPR) with Dynamic Behavior (n=100)")
plt.show()
